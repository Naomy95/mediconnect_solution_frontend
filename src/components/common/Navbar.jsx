  ...
  return (
    <div className="bg-black">
      ...
      <div className="navbar px-4 bg-white lg:bg-navbarcolor lg:px-28 shadow-lg">
        ...
        <div className="navbar-end">
          <div className="lg:flex hidden  lg:items-center  p-2 border rounded-md border-[1px] border-white hover:bg-hoverBackground hover:cursor-pointer hover:text-black">
            <img className="w-1 h-1 lg:w-1/2 lg:h-1/2" src={login} alt="" />

            {token ? (
              <div className="flex  hover:bg-hoverBackground hover:text-black">
                <a
                  className=" text-white text-xs lg:text-lg font-sans lg:pl-2"
                  onClick={() => {
                    localStorage.clear();
              ...
              <label  >
                {" "}
                <a className=" lg:text-white  border-buttoncolor p-2 lg:p-0 rounded-lg text-buttoncolor  text-md mr-4 font-sans ml-2 font-semibold lg:font-normal  hover:text-black">
                  Login
                </a>
                <input
                type="checkbox"
